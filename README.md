...
### Concept
In order to successfully download large data from NCBI GEO by running getGEO() (a fuction in GEOquery), I made a little modification to avoid being time out according to refereces. 
